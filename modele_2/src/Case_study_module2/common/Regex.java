...
public class Regex {
    ...
    public static final String AREA_POOL_REGEX = "^[3-9]+\\d([.]\\d+)?$";

    public static final String RENT_COST_REGEX = "^\\d+([.]\\d+)?$";

    public static final String MAXIMUM_NUMBER_USER_REGEX = "^(0?[1-9]|1[0-9])$";

    public static final String FLOOR_NUMBER_REGEX = "^\\d+([.]\\d+)?$";

    public static final String RENT_TYPE_REGEX = "^\\d+([.]\\d+)?$";

    public static final String ROOM_STANDARD_REGEX = "^\\d+([.]\\d+)?$";
