        ...
        do {
            ...
            switch (choice2) {
                ...
                case 2:
                    ...
                    if (customerController.checkId(id)) {
                        ...
                        do {
                            ...
                            if (Regex.regexAge(Regex.DATE_FORMAT, dateOfBirth)) {
                                break;
                            } else {
                                System.err.println("Format by dd/mm/YYYY ");
                            }
                        } while (true);
                ...
                case 3:
                    ...
                    if (customerController.checkId(idUpdate)) {
